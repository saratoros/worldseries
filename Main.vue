...
<!--            <h1>Discover the top series around the world</h1>-->
            <!--            :width="1000"-->
<!--              <div :class="['show-place',{'active': showCloud},{'between': showCloudBetween}]">-->
                <graph-bubblecloud
                        :minSize="0"
                        :maxSize="2"
                        :width="900"
                        ...
                        @click="clickSeries"
                        :active-event="'mouseover'">
                  <!-- v-b-popover.hover.right="'Popover!'" variant="primary">-->
                </graph-bubblecloud>
<!--              </div>-->
          </b-col>
        </b-row>
      ...
      <b-col md="3">
        ...
        <b-col md="12" style="margin-top: 2em;">
    ...
    export default {
                ...
                (this.Series.find(element => element.year === this.selectedYear)).children.forEach(function (property) {
                    ...
                    if (exists === undefined) {
                        ...
                        if (compatibleGenres && compatibleCountries) {
                            series.push([property.SeriesName, property.AverageDailyDEx, property.Genre])
                        }
                    } else {
        ...
        methods: {
            ...
            selectYear(year) {
                ...
                this.showCloudBetween = false;
                this.selectedYear = year;
                this.selectedCountries = [];
                this.selectedGenres = [];
                setTimeout(function(){ vm.showCloudBetween = true; }, 300);
                setTimeout(function(){ vm.showCloud = true; }, 1500);
        ...
        data() {
            return {
                ...
                selectedCountries: [],
                // colors: function (data) {
                // const genre = Genres.find(element => element.name > data[2]);
                // return genre.color;
                // if (data[2] <= 3000) {
                // return '#497eff';
                // } else if (data[2] <= 7000) {
                ...
                styles: {
                    ...
                    bubbleCloudFontColor : "black",
                    bubbleCloudFontSize: 10,
                },
                Genres: [
        ...
        mounted() {
            ...
            //     serie.children.forEach(function (property) {
            //
            //         let exists = vm.Formatted.find(element => element[0] === property.SeriesName);
            //         if (exists === undefined) {
            //             vm.Formatted.push([property.SeriesName, property.AverageDailyDEx, property.Genre])
            //         } else {
            //             let exists = vm.Formatted.findIndex(element => element[0] === property.SeriesName);
            //             vm.Formatted[exists][1] += property.AverageDailyDEx;
            //         }
            //     })
            // })
        }
